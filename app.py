{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyO+Orlyxd4wpaiCwNKmmcCN",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/laurianerobin/DS11/blob/main/app.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        "print(\"Score sur l'ensemble d'apprentissage :\", model_best.score(X_train, y_train),\"\\n\")\n",
        "print(\"Score sur l'ensemble de test :\", model_best.score(X_test, y_test),\"\\n\")\n",
        "\n",
