...
if pred_rounded >= 100000 and pred_rounded < 150000:
  ...
  st.write(f"Il semblerait que votre recherche soit proche de <a href='{lienhomes}' style='color:#2B92A5; font-weight:bold; text-decoration:none;'>{homes}</a>, actuellement en vente par l'agence immobilière américaine Homes.", unsafe_allow_html=True)
